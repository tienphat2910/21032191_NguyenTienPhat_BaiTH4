...
export default function App() {
  ...
  const footer = [
    {
      image: require('../assets/data/homeicon.png'),
      name: 'Home',
    },
    {
      image: require('../assets/data/exploreicon.png'),
      name: 'Explore',
    },
    {
      image: require('../assets/data/searchicon.png'),
      name: 'Search',
    },
    {
      image: require('../assets/data/profileicon.png'),
      name: 'Profile',
    },
  ];
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          'https://6459bfa395624ceb21eebb61.mockapi.io/TH4/v1/category'
        );
        const data = await response.json();
        setCategory(data);

        const response1 = await fetch(
          'https://6459bfa395624ceb21eebb61.mockapi.io/TH4/v1/location'
        );
